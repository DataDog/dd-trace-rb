...
task :ci do
  ...
  when 2
    sh 'rvm $RAILS30_VERSIONS --verbose do appraisal rails30-mysql2 rake test:rails'
    sh 'rvm $RAILS30_VERSIONS --verbose do appraisal rails30-postgres rake test:rails'
    sh 'rvm $RAILS30_VERSIONS --verbose do appraisal rails30-postgres-redis rake test:railsredis'
    sh 'rvm $RAILS32_VERSIONS --verbose do appraisal rails32-mysql2 rake test:rails'
    sh 'rvm $RAILS32_VERSIONS --verbose do appraisal rails32-postgres rake test:rails'
    sh 'rvm $RAILS32_VERSIONS --verbose do appraisal rails32-postgres-redis rake test:railsredis'
    ...
    sh 'rvm $RAILS30_SIDEKIQ_VERSIONS --verbose do appraisal rails30-postgres-sidekiq rake test:railssidekiq'
    sh 'rvm $RAILS32_SIDEKIQ_VERSIONS --verbose do appraisal rails32-postgres-sidekiq rake test:railssidekiq'
