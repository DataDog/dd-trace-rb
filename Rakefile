...
task :ci do
  ...
  when 1
    ...
    # sh 'rvm $MRI_VERSIONS --verbose do appraisal contrib rake spec:sinatra'
    # sh 'rvm $MRI_VERSIONS --verbose do appraisal contrib rake spec:rack'
    # sh 'rvm $MRI_VERSIONS --verbose do appraisal contrib rake spec:grape'
    # sh 'rvm $MRI_VERSIONS --verbose do appraisal contrib rake spec:faraday'
    # sh 'rvm $MRI_VERSIONS --verbose do appraisal contrib rake spec:aws'
    ...
    # sh 'rvm $MRI_OLD_VERSIONS --verbose do appraisal contrib-old rake spec:sinatra'
    # sh 'rvm $MRI_OLD_VERSIONS --verbose do appraisal contrib-old rake spec:rack'
    # sh 'rvm $MRI_OLD_VERSIONS --verbose do appraisal contrib-old rake spec:faraday'
    # sh 'rvm $MRI_OLD_VERSIONS --verbose do appraisal contrib-old rake spec:aws'
    # sh 'rvm $MRI_OLD_VERSIONS --verbose do appraisal contrib-old rake spec:mongodb'
    # sh 'rvm $MRI_OLD_VERSIONS --verbose do appraisal contrib-old rake spec:sucker_punch'
  ...
  when 2
    ...
    # RSpec
    # sh 'rvm $MRI_VERSIONS --verbose do appraisal contrib rake spec:sidekiq'
    # sh 'rvm $SIDEKIQ_OLD_VERSIONS --verbose do appraisal contrib-old rake spec:sidekiq'
    # sh 'rvm $RAILS3_VERSIONS --verbose do appraisal rails30-postgres rake spec:rails'
    # sh 'rvm $RAILS3_VERSIONS --verbose do appraisal rails30-postgres rake spec:railsdisableenv'
    ...
    # sh 'rvm $RAILS3_VERSIONS --verbose do appraisal rails32-postgres-redis rake spec:railsredis'
    # sh 'rvm $RAILS3_VERSIONS --verbose do appraisal rails32-postgres rake spec:railsdisableenv'
    ...
    # sh 'rvm $RAILS4_VERSIONS --verbose do appraisal rails4-postgres-redis rake spec:railsredis'
    # sh 'rvm $RAILS4_VERSIONS --verbose do appraisal rails4-postgres rake spec:railsdisableenv'
    # sh 'rvm $RAILS3_SIDEKIQ_VERSIONS --verbose do appraisal rails30-postgres-sidekiq rake spec:railssidekiq'
    # sh 'rvm $RAILS3_SIDEKIQ_VERSIONS --verbose do appraisal rails32-postgres-sidekiq rake spec:railssidekiq'
    # sh 'rvm $RAILS4_SIDEKIQ_VERSIONS --verbose do appraisal rails4-postgres-sidekiq rake spec:railssidekiq'
    # sh 'rvm $RAILS4_SIDEKIQ_VERSIONS --verbose do appraisal rails4-postgres-sidekiq rake spec:railsactivejob'
    ...
    # sh 'rvm $RAILS5_VERSIONS --verbose do appraisal rails5-postgres-redis rake spec:railsredis'
    # sh 'rvm $RAILS5_VERSIONS --verbose do appraisal rails5-postgres-sidekiq rake spec:railssidekiq'
    # sh 'rvm $RAILS5_VERSIONS --verbose do appraisal rails5-postgres-sidekiq rake spec:railsactivejob'
    # sh 'rvm $RAILS5_VERSIONS --verbose do appraisal rails5-postgres rake spec:railsdisableenv'
