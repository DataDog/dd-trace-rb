...
TEST_METADATA = {
  ...
  # GraphQL-Ruby does not attempt to deliver "semantic versioning", https://graphql-ruby.org/development#versioning.
  # Breaking changes can be introduced in minor release.
  'graphql' => {
    ...
    # Fix: ArgumentError with class-based schema.
