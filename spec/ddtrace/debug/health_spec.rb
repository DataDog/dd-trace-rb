...
RSpec.describe Datadog::Diagnostics::Health::Metrics do
  ...
  it_behaves_like 'a health metric', :count, :queue_accepted_size, Datadog::Ext::Diagnostics::Health::Metrics::METRIC_QUEUE_ACCEPTED_SIZE
  ...
  it_behaves_like 'a health metric', :gauge, :queue_size, Datadog::Ext::Diagnostics::Health::Metrics::METRIC_QUEUE_SIZE
