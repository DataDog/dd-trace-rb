...
RSpec.describe Datadog::Context do
  ...
  describe '#initialize' do
    ...
    context 'given' do
      context ':trace' do
        ...
        let(:trace) { instance_double(Datadog::TraceOperation, finished?: finished?) }
      ...
      context 'that is finished' do
        ...
        context 'and a block' do
          ...
          context 'outside which another trace is active' do
            let(:original_trace) { instance_double(Datadog::TraceOperation, finished?: false) }
  ...
  describe '#fork_clone' do
    ...
    context 'when a trace is active' do
      let(:trace) { instance_double(Datadog::TraceOperation, finished?: false) }
      let(:cloned_trace) { instance_double(Datadog::TraceOperation, finished?: false) }
