...
RSpec.describe Datadog::TraceOperation do
  ...
  describe '#sampled?' do
    ...
    context 'when :sampling_priority is set to' do
      ...
      context 'AUTO_REJECT' do
        let(:sampling_priority) { Datadog::Ext::Priority::AUTO_REJECT }
        it { is_expected.to be false }
      end
      ...
      context 'USER_REJECT' do
        let(:sampling_priority) { Datadog::Ext::Priority::USER_REJECT }
        it { is_expected.to be false }
      end
    end
      ...
      context 'are both set to matching values' do
        context 'with sampled: true and priority: keep' do
          before do
            ...
            trace_op.sampling_priority = Datadog::Ext::Priority::USER_KEEP
          end
        ...
        context 'with sampled: false and priority: reject' do
          before do
            ...
            trace_op.sampling_priority = Datadog::Ext::Priority::USER_REJECT
          end
  ...
  describe '#keep!' do
    ...
    it do
      expect { keep! }
        ...
        .from(nil)
        .to(Datadog::Ext::Priority::USER_KEEP)
    end
  ...
  describe '#reject!' do
    ...
    it do
      expect { reject! }
        .to change { trace_op.sampling_priority }
        .from(nil)
        .to(Datadog::Ext::Priority::USER_REJECT)
    end
    ...
    context 'given' do
      context ':events' do
        ...
        context 'as Datadog::SpanOperation::Events' do
          let(:events) { Datadog::SpanOperation::Events.new }
        ...
        context 'as Datadog::SpanOperation::Events' do
          it_behaves_like 'a span with default events' do
            ...
            context 'when #on_error is published' do
              let(:event_args) do
                [
                  instance_double(Datadog::SpanOperation),
  ...
  describe '#flush!' do
    ...
    context 'when the trace' do
      ...
      context 'is empty' do
        it { is_expected.to be_a_kind_of(Datadog::TraceSegment) }
      ...
      context 'is finished' do
        ...
        it 'flushes a trace with all spans' do
          ...
          is_expected.to be_a_kind_of(Datadog::TraceSegment)
  ...
  describe '#to_digest' do
    ...
    context 'when the trace' do
      context 'is empty' do
        it { is_expected.to be_a_kind_of(Datadog::TraceDigest) }
