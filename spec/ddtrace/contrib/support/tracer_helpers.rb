...
module Contrib
  ...
  #
  # TODO: Remove this because the tracer no longer has a writer.
  #       This was done before to get spans to write to a buffer instead of a worker.
  #       Now that the tracer emits traces in pub-sub pattern, this is no longer necessary.
  #       see spec/support/tracer_helpers.rb for implementation.
  #
