...
RSpec.describe Datadog::Contrib::Kafka::Integration do
  ...
  describe '#default_configuration' do
    ...
    it { is_expected.to be_a_kind_of(Datadog::Contrib::Kafka::Configuration::Settings) }
  end

  describe '#patcher' do
    subject(:patcher) { integration.patcher }

    it { is_expected.to be Datadog::Contrib::Kafka::Patcher }
  end
end
