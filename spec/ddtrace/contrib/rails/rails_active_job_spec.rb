  ...
  context 'with active_job instrumentation' do
    ...
    it 'instruments enqueue' do
      ...
      expect(span.get_tag(Datadog::Ext::Metadata::TAG_COMPONENT))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_COMPONENT)
      expect(span.get_tag(Datadog::Ext::Metadata::TAG_OPERATION))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_OPERATION_ENQUEUE)
    ...
    it 'instruments perform' do
      ...
      expect(span.get_tag(Datadog::Ext::Metadata::TAG_COMPONENT))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_COMPONENT)
      expect(span.get_tag(Datadog::Ext::Metadata::TAG_OPERATION))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_OPERATION_PERFORM)
    ...
    it 'instruments active_job.enqueue_retry and active_job.retry_stopped' do
      ...
      expect(enqueue_retry_span.get_tag(Datadog::Ext::Metadata::TAG_COMPONENT))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_COMPONENT)
      expect(enqueue_retry_span.get_tag(Datadog::Ext::Metadata::TAG_OPERATION))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_OPERATION_ENQUEUE_RETRY)
      ...
      expect(retry_stopped_span.get_tag(Datadog::Ext::Metadata::TAG_COMPONENT))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_COMPONENT)
      expect(retry_stopped_span.get_tag(Datadog::Ext::Metadata::TAG_OPERATION))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_OPERATION_RETRY_STOPPED)
    ...
    it 'instruments discard' do
      ...
      expect(span.get_tag(Datadog::Ext::Metadata::TAG_COMPONENT))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_COMPONENT)
      expect(span.get_tag(Datadog::Ext::Metadata::TAG_OPERATION))
        .to eq(Datadog::Contrib::ActiveJob::Ext::TAG_OPERATION_DISCARD)
