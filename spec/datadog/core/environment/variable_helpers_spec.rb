...
RSpec.describe Datadog::Core::Environment::VariableHelpers do
  ...
  describe '::env_to_hash' do
    subject(:env_to_hash) { variable_helpers.env_to_hash(var, comma_separated_only: false, **options) }
    ...
    context 'when env var is not defined' do
      ...
      context 'and default is defined' do
        subject(:env_to_hash) { variable_helpers.env_to_hash(var, default, comma_separated_only: false) }
    ...
    context 'when env var is set' do
      ...
      context 'and comma_separated_only is set' do
        subject(:env_to_hash) { variable_helpers.env_to_hash(var, comma_separated_only: true) }
