...
RSpec.describe 'InternalEvaluator Rule Evaluation' do
  describe 'numeric comparison rules' do
    ...
    it 'passes rule for users meeting age requirement' do
      ...
      result = evaluator.get_assignment(nil, "age_gated_flag", adult_context, :boolean, Time.now, false)
    ...
    it 'fails rule for users not meeting age requirement' do
      ...
      result = evaluator.get_assignment(nil, "age_gated_flag", minor_context, :boolean, Time.now, false)
    ...
    it 'fails rule when required attribute is missing' do
      ...
      result = evaluator.get_assignment(nil, "age_gated_flag", no_age_context, :boolean, Time.now, false)
  ...
  describe 'membership rules (ONE_OF)' do
    ...
    it 'passes rule when attribute matches one of the values' do
      ...
      result = evaluator.get_assignment(nil, "tier_flag", premium_context, :string, Time.now, "default")
    ...
    it 'passes rule when attribute matches another value in the list' do
      ...
      result = evaluator.get_assignment(nil, "tier_flag", enterprise_context, :string, Time.now, "default")
    ...
    it 'fails rule when attribute does not match any value' do
      ...
      result = evaluator.get_assignment(nil, "tier_flag", basic_context, :string, Time.now, "default")
  ...
  describe 'multiple conditions in single rule' do
    ...
    it 'passes rule when all conditions are met' do
      ...
      result = evaluator.get_assignment(nil, "complex_rule_flag", eligible_context, :boolean, Time.now, false)
    ...
    it 'fails rule when first condition fails' do
      ...
      result = evaluator.get_assignment(nil, "complex_rule_flag", young_us_context, :boolean, Time.now, false)
    ...
    it 'fails rule when second condition fails' do
      ...
      result = evaluator.get_assignment(nil, "complex_rule_flag", adult_non_us_context, :boolean, Time.now, false)
    ...
    it 'fails rule when both conditions fail' do
      ...
      result = evaluator.get_assignment(nil, "complex_rule_flag", ineligible_context, :boolean, Time.now, false)
  ...
  describe 'multiple rules in allocation (OR logic)' do
    ...
    it 'matches allocation when first rule passes' do
      ...
      result = evaluator.get_assignment(nil, "multi_rule_flag", admin_context, :string, Time.now, "default")
    ...
    it 'matches allocation when second rule passes' do
      ...
      result = evaluator.get_assignment(nil, "multi_rule_flag", senior_context, :string, Time.now, "default")
    ...
    it 'matches allocation when both rules pass' do
      ...
      result = evaluator.get_assignment(nil, "multi_rule_flag", admin_senior_context, :string, Time.now, "default")
    ...
    it 'uses fallback allocation when no rules pass' do
      ...
      result = evaluator.get_assignment(nil, "multi_rule_flag", regular_context, :string, Time.now, "default")
  ...
  describe 'regex rules' do
    ...
    it 'matches when regex pattern matches' do
      ...
      result = evaluator.get_assignment(nil, "regex_flag", matching_context, :boolean, Time.now, false)
    ...
    it 'fails when regex pattern does not match' do
      ...
      result = evaluator.get_assignment(nil, "regex_flag", non_matching_context, :boolean, Time.now, false)
  ...
  describe 'null check rules' do
    ...
    it 'matches when attribute exists (IS_NULL = false)' do
      ...
      result = evaluator.get_assignment(nil, "null_check_flag", has_phone_context, :string, Time.now, "default")
    ...
    it 'fails when attribute is missing (IS_NULL = false)' do
      ...
      result = evaluator.get_assignment(nil, "null_check_flag", no_phone_context, :string, Time.now, "default")
  ...
  describe 'NOT_ONE_OF rules' do
    ...
    it 'passes when attribute is not in blocked list' do
      ...
      result = evaluator.get_assignment(nil, "exclusion_flag", allowed_context, :boolean, Time.now, false)
    ...
    it 'fails when attribute is in blocked list' do
      ...
      result = evaluator.get_assignment(nil, "exclusion_flag", blocked_context, :boolean, Time.now, false)
    ...
    it 'fails when attribute is missing (NOT_ONE_OF fails for missing attributes)' do
      ...
      result = evaluator.get_assignment(nil, "exclusion_flag", no_country_context, :boolean, Time.now, false)
