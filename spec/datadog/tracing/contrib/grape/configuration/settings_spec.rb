...
RSpec.describe Datadog::Tracing::Contrib::Grape::Configuration::Settings do
  ...
  it_behaves_like 'with error_status_codes setting', env: 'DD_TRACE_GRAPE_ERROR_STATUS_CODES', default: 500...600, settings_class: described_class, option: :error_status_codes
end
