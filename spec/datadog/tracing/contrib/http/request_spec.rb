...
RSpec.describe 'net/http requests' do
  ...
  before do
    Datadog::Tracing.configure { |c| c.tracing.instrument :http, configuration_options }
  end
  ...
  describe 'distributed tracing' do
    ...
    context 'when disabled' do
      before do
        Datadog::Tracing.configure { |c| c.tracing.instrument :http, distributed_tracing: false }
        client.get(path)
      end

      after do
        Datadog::Tracing.configure { |c| c.tracing.instrument :http, distributed_tracing: true }
      end
