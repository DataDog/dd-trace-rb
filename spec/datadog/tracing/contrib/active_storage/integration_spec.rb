...
RSpec.describe Datadog::Tracing::Contrib::ActiveStorage::Integration do
  ...
  describe '#default_configuration' do
    ...
    it { is_expected.to be_a_kind_of(Datadog::Tracing::Contrib::ActiveStorage::Configuration::Settings) }
  end

  describe '#patcher' do
    subject(:patcher) { integration.patcher }

    it { is_expected.to be Datadog::Tracing::Contrib::ActiveStorage::Patcher }
  end
end
