  ...
  context 'service name env var testing' do
    ...
    context 'test the default' do
      it do
        ...
        span.set_tag("expected_service_name", 'rspec')
        span.set_tag("remove_integration_service_names_enabled", "true")
      end
    end
    ...
    context 'service name test with integration service name' do
      ...
      it do
        ...
        span.set_tag("expected_service_name", configuration_options[:service_name])
        span.set_tag("remove_integration_service_names_enabled", "true")
      end
    end
  end
