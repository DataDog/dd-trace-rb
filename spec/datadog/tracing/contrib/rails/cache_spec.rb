...
RSpec.describe 'Rails cache' do
  ...
  before do
    Datadog::Tracing.configuration.tracing[:active_support][:cache_service] = 'rails-cache'
  end

  after do
    Datadog::Tracing.configuration.tracing[:active_support].reset!
  end
  ...
  describe '#write' do
    ...
    context 'with custom cache_service' do
      before { Datadog::Tracing.configuration.tracing[:active_support][:cache_service] = 'service-cache' }
