...
RSpec.describe Datadog::Tracing::Contrib::Httprb::Configuration::Settings do
  ...
  it_behaves_like 'with error_status_codes setting', env: 'DD_TRACE_HTTPRB_ERROR_STATUS_CODES', default: 400...600, settings_class: described_class, option_path: [:error_status_codes]
end
