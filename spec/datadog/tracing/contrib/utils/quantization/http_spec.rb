...
RSpec.describe Datadog::Tracing::Contrib::Utils::Quantization::HTTP do
  ...
  describe 'OBFUSCATOR_REGEX' do
    ...
    value_matches = {
      ...
      'OpenSSH ECDSA public key' => 'ecdsa-sha2-nistp256	AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBJX/IRZ4icqvJ8OpEDMs5X566bilqX6u6XEF/f/llF4YmiiSpo6cTVzl/2L9HXSfOlwuzVyRFaLpMWEUE3az0PI=	dummy comment'
    }
