...
RSpec.describe Datadog::Tracing::Correlation::Identifier do
  let(:env) { 'default-env' }
  ...
  before do
    ...
    allow(settings).to receive(:env).and_return(env)
    ...
    context 'when #trace_id' do
            ...
            it_behaves_like 'a log format string' do
              ...
              it do
                is_expected.to have_attribute(
                  "#{described_class::LOG_ATTR_TRACE_ID}=#{expected_trace_id}"
                )
              end
            end
          end
        ...
        context 'when 128 bit trace id logging is enabled' do
          ...
          context 'when given > 64 bit trace id' do
            it_behaves_like 'a log format string' do
              ...
              it do
                is_expected.to have_attribute(
                  "#{described_class::LOG_ATTR_TRACE_ID}=ffffffffffffffffaaaaaaaaaaaaaaaa"
                )
              end
            end
          end
      ...
      context 'is not defined' do
        it_behaves_like 'a log format string' do
          ...
          it do
            is_expected.to have_attribute(
              "#{described_class::LOG_ATTR_TRACE_ID}=0"
            )
          end
        end
      end
    ...
    context 'when #span_id' do
      context 'is defined' do
        it_behaves_like 'a log format string' do
          ...
          it do
            is_expected.to have_attribute(
              "#{described_class::LOG_ATTR_SPAN_ID}=#{span_id}"
            )
          end
        end
      end
      ...
      context 'is not defined' do
        it_behaves_like 'a log format string' do
          ...
          it do
            is_expected.to have_attribute(
              "#{described_class::LOG_ATTR_SPAN_ID}=0"
            )
          end
        end
      end
    ...
    context 'when #env' do
      context 'is defined' do
        it_behaves_like 'a log format string' do
          ...
          it do
            is_expected.to have_attribute(
              "#{described_class::LOG_ATTR_ENV}=#{env}"
            )
          end
    ...
    context 'when #service' do
      context 'is defined' do
        it_behaves_like 'a log format string' do
          ...
          it do
            is_expected.to have_attribute(
              "#{described_class::LOG_ATTR_SERVICE}=#{service}"
            )
          end
    ...
    context 'when #version' do
      context 'is defined' do
        it_behaves_like 'a log format string' do
          ...
          it do
            is_expected.to have_attribute(
              "#{described_class::LOG_ATTR_VERSION}=#{version}"
            )
          end
      ...
      context 'is not defined' do
        it_behaves_like 'a log format string' do
          ...
          it do
            is_expected.to_not have_attribute(
              "#{described_class::LOG_ATTR_VERSION}="
            )
          end
        end
      end
