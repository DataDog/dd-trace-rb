...
class MonkeyTest < Minitest::Test
  ...
  def test_patch_module
    ...
    assert_equal({ rails: false, elasticsearch: false, http: false, redis: false, grape: false, faraday: false, aws: false, sucker_punch: false, active_record: false, mongo: false, dalli: false, resque: false, rack: false, racecar: false }, Datadog::Monkey.get_patched_modules())
    ...
    assert_equal({ rails: false, elasticsearch: false, http: false, redis: true, grape: false, faraday: false, aws: false, sucker_punch: false, active_record: false, mongo: false, dalli: false, resque: false, rack: false, racecar: false }, Datadog::Monkey.get_patched_modules())
    ...
    assert_equal(false, Datadog::Contrib::Aws::Patcher.patched?)
    assert_equal(false, Datadog::Contrib::ActiveRecord::Patcher.patched?)
    assert_equal({ rails: false, elasticsearch: true, http: false, redis: true, grape: false, faraday: false, aws: false, sucker_punch: false, active_record: false, mongo: false, dalli: false, resque: false, rack: false, racecar: false }, Datadog::Monkey.get_patched_modules())
    ...
    assert_equal(false, Datadog::Contrib::ActiveRecord::Patcher.patched?)
    assert_equal({ rails: false, elasticsearch: true, http: true, redis: true, grape: false, faraday: true, aws: true, sucker_punch: true, active_record: false, mongo: false, dalli: true, resque: true, rack: false, racecar: false }, Datadog::Monkey.get_patched_modules())
