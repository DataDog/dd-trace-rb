...
target :datadog do
  ...
  ignore 'lib/datadog/tracing/contrib/action_cable/'
  ignore 'lib/datadog/tracing/contrib/action_mailer/'
  ignore 'lib/datadog/tracing/contrib/action_pack/'
  ignore 'lib/datadog/tracing/contrib/action_view/'
  ignore 'lib/datadog/tracing/contrib/active_job/'
  ignore 'lib/datadog/tracing/contrib/active_model_serializers/'
  ignore 'lib/datadog/tracing/contrib/active_record/'
  ignore 'lib/datadog/tracing/contrib/active_support/'
  ignore 'lib/datadog/tracing/contrib/analytics.rb'
  ignore 'lib/datadog/tracing/contrib/aws/'
  ignore 'lib/datadog/tracing/contrib/concurrent_ruby/'
  ignore 'lib/datadog/tracing/contrib/cucumber/'
  ignore 'lib/datadog/tracing/contrib/dalli/'
  ignore 'lib/datadog/tracing/contrib/delayed_job/'
  ignore 'lib/datadog/tracing/contrib/elasticsearch/'
  ignore 'lib/datadog/tracing/contrib/ethon/'
  ignore 'lib/datadog/tracing/contrib/excon/'
  ignore 'lib/datadog/tracing/contrib/faraday/'
  ignore 'lib/datadog/tracing/contrib/grape/'
  ignore 'lib/datadog/tracing/contrib/graphql/configuration/'
  ...
  ignore 'lib/datadog/tracing/contrib/karafka/'
  ignore 'lib/datadog/tracing/contrib/patcher.rb'
  ignore 'lib/datadog/tracing/contrib/configuration/resolver.rb'
  ignore 'lib/datadog/tracing/contrib/propagation/'
  ignore 'lib/datadog/tracing/contrib/ext.rb'
  ignore 'lib/datadog/tracing/contrib/registerable.rb'
  ignore 'lib/datadog/tracing/contrib/roda/'
  ignore 'lib/datadog/tracing/contrib/sneakers/'
  ignore 'lib/datadog/tracing/contrib/trilogy/'
  ...
  ignore 'lib/datadog/tracing/contrib/grpc/'
  ignore 'lib/datadog/tracing/contrib/hanami/'
  ignore 'lib/datadog/tracing/contrib/http.rb'
  ignore 'lib/datadog/tracing/contrib/http/'
  ignore 'lib/datadog/tracing/contrib/httpclient/'
  ignore 'lib/datadog/tracing/contrib/httprb/'
  ignore 'lib/datadog/tracing/contrib/integration.rb'
  ignore 'lib/datadog/tracing/contrib/kafka/'
  ignore 'lib/datadog/tracing/contrib/lograge/'
  ignore 'lib/datadog/tracing/contrib/mongodb/'
  ignore 'lib/datadog/tracing/contrib/mysql2/'
  ignore 'lib/datadog/tracing/contrib/opensearch/'
  ignore 'lib/datadog/tracing/contrib/pg/'
  ignore 'lib/datadog/tracing/contrib/presto/'
  ignore 'lib/datadog/tracing/contrib/qless/'
  ignore 'lib/datadog/tracing/contrib/que/'
  ignore 'lib/datadog/tracing/contrib/racecar/'
  ignore 'lib/datadog/tracing/contrib/rack/'
  ignore 'lib/datadog/tracing/contrib/rails/'
  ignore 'lib/datadog/tracing/contrib/rake/'
  ignore 'lib/datadog/tracing/contrib/redis/'
  ignore 'lib/datadog/tracing/contrib/registry.rb'
  ignore 'lib/datadog/tracing/contrib/resque/'
  ignore 'lib/datadog/tracing/contrib/rest_client/'
  ignore 'lib/datadog/tracing/contrib/rspec/'
  ignore 'lib/datadog/tracing/contrib/semantic_logger/'
  ignore 'lib/datadog/tracing/contrib/sequel/'
  ignore 'lib/datadog/tracing/contrib/shoryuken/'
  ignore 'lib/datadog/tracing/contrib/sidekiq.rb'
  ignore 'lib/datadog/tracing/contrib/sidekiq/'
  ignore 'lib/datadog/tracing/contrib/sinatra/'
  ignore 'lib/datadog/tracing/contrib/stripe/'
  ignore 'lib/datadog/tracing/contrib/sucker_punch/'
