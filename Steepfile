...
target :datadog do
  ...
  # Integration patching relies on RIC constants supplied by the AWS Lambda runtime.
  ignore "lib/datadog/tracing/contrib/aws_lambda_ric/configuration/settings.rb"
  ignore "lib/datadog/tracing/contrib/aws_lambda_ric/instrumentation.rb"
  ignore "lib/datadog/tracing/contrib/aws_lambda_ric/integration.rb"
  ignore "lib/datadog/tracing/contrib/aws_lambda_ric/patcher.rb"
