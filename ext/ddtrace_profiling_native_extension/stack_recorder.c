...
NOGVL_SAFE static void *call_serialize_without_gvl(void *call_args);
...
NOGVL_SAFE static ddog_prof_Profile *serializer_flip_active_and_inactive_slots(struct stack_recorder_state *state);
