...
typedef enum ddog_crasht_CallbackResult {
  ...
  DDOG_CRASHT_CALLBACK_RESULT_NULL_CALLBACK,
  DDOG_CRASHT_CALLBACK_RESULT_UNKNOWN_ERROR,
} ddog_crasht_CallbackResult;

/**
 * Callback type identifier for different collection strategies
 */
typedef enum ddog_crasht_CallbackType {
  DDOG_CRASHT_CALLBACK_TYPE_FRAME,
  DDOG_CRASHT_CALLBACK_TYPE_STACKTRACE_STRING,
} ddog_crasht_CallbackType;
 ...
 */
typedef void (*ddog_crasht_RuntimeStackCallback)(void (*emit_frame)(const struct ddog_crasht_RuntimeStackFrame*),
