 ...
 */
enum ddog_crasht_CallbackResult ddog_crasht_register_runtime_stack_callback(ddog_crasht_RuntimeStackCallback callback,
                                                                            enum ddog_crasht_CallbackType callback_type);
