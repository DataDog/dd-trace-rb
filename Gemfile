...
gem 'pimpmychangelog', '>= 0.1.3'
gem 'pry', '>= 0.12.2'
if RUBY_PLATFORM != 'java'
  # There's a few incompatibilities between pry/pry-byebug on older Rubies
  gem 'pry-byebug', '>= 3.8.0' if RUBY_VERSION >= '2.6.0' && RUBY_ENGINE != 'truffleruby'
  gem 'pry-nav', '>= 0.3.0' if RUBY_VERSION < '2.6.0'
  gem 'pry-stack_explorer', '>= 0.4.9.3'
else
  gem 'pry-debugger-jruby', '>= 2.0.0'
end
gem 'rake', '>= 12.0', '< 13.0.4' # Locking rake until https://github.com/thoughtbot/appraisal/pull/184 is released
gem 'redcarpet', '~> 3.5' if RUBY_PLATFORM != 'java'
gem 'rspec', '~> 3.10'
...
gem 'warning', '~> 1.2' if RUBY_VERSION >= '2.5.0'
gem 'webmock', '~> 3.13'
if RUBY_VERSION < '2.3.0'
  gem 'rexml', '3.2.4' # Pinned due to https://github.com/ruby/rexml/issues/69
end
