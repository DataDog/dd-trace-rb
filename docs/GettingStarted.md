...
To export spans created by `datadog` over OTLP HTTP, set `OTEL_TRACES_EXPORTER=otlp`. See [Exporting Datadog traces over OTLP](OpenTelemetry.md#exporting-datadog-traces-over-otlp) for endpoint, header, timeout, and protocol configuration.
...
| `tracing.otlp.exporter`                                | `OTEL_TRACES_EXPORTER`                                  | `String`                              | `nil`                        | Set to `otlp` to export Datadog spans through OTLP HTTP using libdatadog.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `tracing.otlp.agent_protocol_version`                  | `DD_TRACE_AGENT_PROTOCOL_VERSION`                       | `String`                              | `nil`                        | When set, keeps the Datadog Agent trace protocol selected instead of OTLP.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `tracing.otlp.endpoint`                                | `OTEL_EXPORTER_OTLP_TRACES_ENDPOINT`                    | `String`                              | `nil`                        | OTLP trace endpoint. Falls back to `OTEL_EXPORTER_OTLP_ENDPOINT` and then `http://<agent-host>:4318/v1/traces`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `tracing.otlp.headers`                                 | `OTEL_EXPORTER_OTLP_TRACES_HEADERS`                     | `Hash`                                | `nil`                        | Comma-separated OTLP trace request headers. Falls back to `OTEL_EXPORTER_OTLP_HEADERS`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `tracing.otlp.timeout_millis`                          | `OTEL_EXPORTER_OTLP_TRACES_TIMEOUT`                     | `Integer`                             | `nil`                        | OTLP trace export timeout in milliseconds. Falls back to `OTEL_EXPORTER_OTLP_TIMEOUT`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `tracing.otlp.protocol`                                | `OTEL_EXPORTER_OTLP_TRACES_PROTOCOL`                    | `String`                              | `nil`                        | OTLP trace protocol. Supports `http/json` and `http/protobuf` and falls back to `OTEL_EXPORTER_OTLP_PROTOCOL`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
