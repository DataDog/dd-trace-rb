...
| `tracing.sampling.rate_limit`                           | `DD_TRACE_RATE_LIMIT`          | `100`                                                             | Sets a maximum number of traces per second to sample. Defaults to 100 per second. Set a rate limit to avoid the ingestion volume overages in the case of traffic spikes.                                                                    |
