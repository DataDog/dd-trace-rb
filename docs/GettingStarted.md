...
| `tracing.partial_flush.min_spans_threshold`            | `DD_TRACE_PARTIAL_FLUSH_MIN_SPANS_THRESHOLD`            | `Integer`                             | `500`                        | The number of spans that must be completed in a trace before partial flushing submits those completed spans.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
