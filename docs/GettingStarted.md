...
| `tracing.sampling.span_rules`                          | `DD_SPAN_SAMPLING_RULES`                                | `String`                              | `nil`                        | Sets [Single Span Sampling](#single-span-sampling) rules inline. These rules allow you to keep spans even when their respective traces are dropped.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `tracing.sampling.span_rules_file`                     | `DD_SPAN_SAMPLING_RULES_FILE`                           | `String`                              | `nil`                        | Sets the path to a file from which [Single Span Sampling](#single-span-sampling) rules are loaded. When both `tracing.sampling.span_rules` and `tracing.sampling.span_rules_file` are set, inline rules take precedence.                                                                                                                                                                                                                                                                                                                                                                                                              |
