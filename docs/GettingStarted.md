...
| `mailer_service` | Service name used when tracing ActionMailer activity. | `<app_name>-action_mailer` |
| `cable_service` | Service name used when tracing ActionCable activity. | `<app_name>-action_cable` |
