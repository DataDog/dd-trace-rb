...
| `telemetry.enabled`                                     | `DD_INSTRUMENTATION_TELEMETRY_ENABLED` | `false`                                                             | Allows you to enable sending telemetry data to Datadog. See [Telemetry collection](https://docs.datadoghq.com/tracing/configure_data_security/#telemetry-collection) for more details.                                                                                                                                                                                          |
| **Tracing**                                             |                                |                                                                   |                                                                                                                                                                                                                                           |
