...
At this point, if you are on a supported integration, you should be able to generate traffic and view
...
config or your initializer file, you can override the following defaults:

    # config/initializers/datadog-tracer.rb
    # you may override only settings different from the values below
...
If you need to instrument custom code within your controllers, you can simply:
    ...
    class CustomController < ApplicationController
      def index
        ...
        # get the Rails tracer and instrument this code
