...
class Addressable::Template
  ...
  def expand(mapping, processor = nil); end
  ...
  def partial_expand(mapping, processor = nil); end
  def pattern; end
  def source; end
  def to_regexp; end
  def transform_capture(mapping, capture, processor = nil); end
  def transform_partial_capture(mapping, capture, processor = nil); end
