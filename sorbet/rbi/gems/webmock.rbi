...
class Net::HTTP < Net::HTTP
  def build_net_http_response(webmock_response, &block); end
  def build_webmock_response(net_http_response); end
  def check_right_http_connection; end
  def request(request, body = nil, &block); end
  def self.const_defined?(name, inherit = nil); end
  def self.const_get(name, inherit = nil); end
  def self.constants(inherit = nil); end
  def self.socket_type; end
  def start(&block); end
  def start_with_connect; end
  def start_with_connect_without_finish; end
  def start_without_connect; end
  def timeout_exception; end
end
