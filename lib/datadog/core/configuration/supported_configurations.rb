    ...
    module Configuration
      ...
      ALIASES =
        {"DD_DISABLE_DATADOG_RAILS" => ["DISABLE_DATADOG_RAILS"],
         "DD_DYNAMIC_INSTRUMENTATION_MAX_TIME_TO_SERIALIZE" => ["DD_DYNAMIC_INSTRUMENTATION_CAPTURE_TIMEOUT_MS"],
      ...
      ALIAS_TO_CANONICAL =
        {"DD_DYNAMIC_INSTRUMENTATION_CAPTURE_TIMEOUT_MS" => "DD_DYNAMIC_INSTRUMENTATION_MAX_TIME_TO_SERIALIZE",
