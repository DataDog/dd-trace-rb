    ...
    module Transport
      ...
      module Ext
        module HTTP
          ...
          # Opt-in header to receive real HTTP status codes from the Trace Agent.
          # When set, the agent will return 429 Too Many Requests during backpressure instead of 200 OK.
