        ...
        class AppStarted < Base
          ...
          def configuration(settings, agent_settings)
            ...
            list.push(
              ...
              conf_value('OTEL_EXPORTER_OTLP_HEADERS', DATADOG_ENV['OTEL_EXPORTER_OTLP_HEADERS'], seq_id, 'env_var'),
              ...
              conf_value('OTEL_EXPORTER_OTLP_METRICS_HEADERS', DATADOG_ENV['OTEL_EXPORTER_OTLP_METRICS_HEADERS'], seq_id, 'env_var'),
