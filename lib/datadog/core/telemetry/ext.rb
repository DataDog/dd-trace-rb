  ...
  module Core
    module Telemetry
      module Ext
        ...
        ENV_AGENTLESS_ENABLED = 'DD_INSTRUMENTATION_TELEMETRY_AGENTLESS_ENABLED'
        ...
        ENV_SHUTDOWN_TIMEOUT_SECONDS = 'DD_TELEMETRY_SHUTDOWN_TIMEOUT_SECONDS'
        ENV_LOG_COLLECTION = 'DD_TELEMETRY_LOG_COLLECTION_ENABLED'
        ENV_DEBUG = 'DD_TELEMETRY_DEBUG'
      end
    end
  end
end
