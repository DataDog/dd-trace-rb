    ...
    module Environment
      ...
      module Git
        def self.git_repository_url
          ...
          @git_repository_url = Utils::Url.filter_basic_auth(Datadog.get_environment_variable(Datadog::Core::Git::Ext::ENV_REPOSITORY_URL))
        end

        def self.git_commit_sha
          return @git_commit_sha if defined?(@git_commit_sha)

          @git_commit_sha = Datadog.get_environment_variable(Datadog::Core::Git::Ext::ENV_COMMIT_SHA)
        end
      end
    end
  end
