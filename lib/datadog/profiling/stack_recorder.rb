module Datadog
  module Profiling
    ...
    class StackRecorder
      def initialize(cpu_time_enabled:, alloc_samples_enabled:, power_enabled: false)
        ...
        self.class._native_initialize(self, cpu_time_enabled, alloc_samples_enabled, power_enabled)
      end
