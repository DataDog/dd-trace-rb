...
module Datadog
  ...
  module Tracing
    class << self
      ...
      # `Datadog::Tracing.configure` call block.
      #
      ...
      #
      # For example, for `Datadog::Tracing.configure_onto(redis_client, **opts)`, `opts` can be
      ...
      # client = Net::HTTP.new(host, port)
      # Datadog::Tracing.configure_onto(client, service_name: 'api-requests', split_by_domain: true)
      # config = Datadog::Tracing.configuration_for(client)
