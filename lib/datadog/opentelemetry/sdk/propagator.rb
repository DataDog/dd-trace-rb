    ...
    module SDK
      ...
      class Propagator
        ...
        def extract(
          ...
          # DD_TRACE_PROPAGATION_BEHAVIOR_EXTRACT='restart': the propagator returns a digest with
          # no trace_id/span_id so the new trace starts fresh. Skip OTel span-context creation
