    ...
    module Contrib
      module Sinatra
        module Gateway
          ...
          module Watcher
            WATCH_REQUEST_DISPATCH_ONCE = Core::Utils::OnlyOnce.new
            WATCH_REQUEST_ROUTED_ONCE = Core::Utils::OnlyOnce.new
            ...
            class << self
              ...
              def watch_request_dispatch(gateway = Instrumentation.gateway)
                WATCH_REQUEST_DISPATCH_ONCE.run do
              ...
              def watch_request_routed(gateway = Instrumentation.gateway)
                WATCH_REQUEST_ROUTED_ONCE.run do
