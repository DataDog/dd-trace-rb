      ...
      module Rack
        ...
        class RequestMiddleware
          ...
          def add_appsec_tags(security_engine, context)
            ...
            if security_engine.diagnostics
              diagnostics = security_engine.diagnostics
              ...
              unless @oneshot_tags_sent
                ...
                span.set_tag('_dd.appsec.event_rules.addresses', JSON.dump(security_engine.addresses))
