        ...
        def self.extended(base)
          base.class_eval do
            ...
            settings :tracing do
              ...
              # containing a route will be reported in traces.
              #
              # For web applications built with frameworks which are instrumented, http.endpoint tag
              # will contain the route as it is defined in the application. For basic Rack applications,
