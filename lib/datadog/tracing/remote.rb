    ...
    module Remote
      class << self
        ...
        CAPABILITIES = [
          ...
          # Lives here (not in DI::Remote.capabilities) because
          # dynamic_instrumentation_enabled is delivered in APM_TRACING
          # payloads — see process_config below, which routes it to
          # Datadog::DI::Remote.handle_rc_enablement.
