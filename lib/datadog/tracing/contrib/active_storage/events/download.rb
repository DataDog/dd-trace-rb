  ...
  module Tracing
    module Contrib
      module ActiveStorage
        module Events
          # Defines instrumentation for 'service_download.active_storage' event.
          #
          # A blob hosted on the remote service was downloaded
          module Download
            include ActiveStorage::Event

            EVENT_NAME = 'service_download.active_storage'.freeze
            ...
            def process(span, _event, _id, payload)
              ...
              span.set_tag(Tracing::Metadata::Ext::TAG_OPERATION, Ext::TAG_OPERATION_DOWNLOAD)
