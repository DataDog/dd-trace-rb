    ...
    module Contrib
      module Rails
        ...
        module Ext
          ...
          ENV_SERVICE_NAME = 'DD_TRACE_RAILS_SERVICE_NAME'
          ENV_REQUEST_QUEUING = 'DD_TRACE_RAILS_REQUEST_QUEUING'
          ENV_MIDDLEWARE = 'DD_TRACE_RAILS_MIDDLEWARE'
          ENV_MIDDLEWARE_NAMES = 'DD_TRACE_RAILS_MIDDLEWARE_NAMES'
          ENV_TEMPLATE_BASE_PATH = 'DD_TRACE_RAILS_TEMPLATE_BASE_PATH'
