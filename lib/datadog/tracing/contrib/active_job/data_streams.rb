  ...
  module Tracing
    module Contrib
      module ActiveJob
        ...
        module DataStreams
          # Injects the pathway context when a job is serialized for enqueueing.
          module SerializePatch
            def serialize
              job_data = super
          ...
          # Extracts the pathway context when a job is deserialized for performing.
          module DeserializePatch
