        ...
        module ActionController
          ...
          module Instrumentation
            ...
            def start_processing(payload)
              # trace the execution
              service = Tracing.configuration.tracing[:action_pack][:service_name]
            ...
            def exception_controller?(payload)
              exception_controller_class = Tracing.configuration.tracing[:action_pack][:exception_controller]
