    ...
    module Propagation
      ...
      module HTTP
        ...
        def self.inject!(digest, env)
          ...
          Tracing.configuration.distributed_tracing.propagation_inject_style.each do |style|
        ...
        def self.extract(env)
          ...
          Tracing.configuration.distributed_tracing.propagation_extract_style.each do |style|
            propagator = PROPAGATION_STYLES[style]
