  ...
  module Configuration
    ...
    class Settings
      ...
      option :service do |o|
        ...
        o.default { ENV.fetch(Ext::Environment::ENV_SERVICE, Core::Ext::Environment::FALLBACK_SERVICE_NAME) }
        o.lazy
        ...
        o.helper(:service_without_fallback) do
          ...
          service_name unless service_name.equal?(Core::Ext::Environment::FALLBACK_SERVICE_NAME)
        end
      end
