  ...
  module Contrib
    module Redis
      ...
      module Quantize
        ...
        def format_arg(arg)
          a = arg.to_s
          a = a[0..(VALUE_MAX_LEN - TOO_LONG_MARK.length)] + TOO_LONG_MARK if a.length > VALUE_MAX_LEN
          a
        ...
        def format_command_args(command_args)
          ...
          cmd = cmd[0..(CMD_MAX_LEN - TOO_LONG_MARK.length)] + TOO_LONG_MARK if cmd.length > CMD_MAX_LEN
          cmd
        end
      end
    end
