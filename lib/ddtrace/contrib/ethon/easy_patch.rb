      ...
      module EasyPatch
        ...
        module InstanceMethods
          ...
          def datadog_tag_request
            ...
            span.set_tag(Tracing::Metadata::Ext::HTTP::TAG_URL, this_uri.path)
            span.set_tag(Tracing::Metadata::Ext::HTTP::TAG_METHOD, method)
            span.set_tag(Tracing::Metadata::Ext::NET::TAG_TARGET_HOST, this_uri.host)
            span.set_tag(Tracing::Metadata::Ext::NET::TAG_TARGET_PORT, this_uri.port)

            span.set_tag(Tracing::Metadata::Ext::TAG_PEER_HOSTNAME, this_uri.host)
          end
