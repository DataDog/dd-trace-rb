...
module Datadog
  ...
  class Writer
    ...
    def initialize(options = {})
      ...
      # TODO[manu]: add a mutex before fork
      # @pid = nil
      ...
      @trace_worker = Datadog::Workers::AsyncTransport.new(spans_interval, @transport, buff_size) do |items, transport|
        send_spans(items, transport)
      end
      @service_worker = Datadog::Workers::AsyncTransport.new(services_interval, @transport, 1) do |items, transport|
