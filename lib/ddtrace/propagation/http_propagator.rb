    ...
    def self.extract(env)
      ...
      Datadog.configuration.propagation_extract_style.each do |style|
        ...
        when PROPAGATION_STYLE_DATADOG
          extracted_context = DistributedTracing::Datadog.extract(env)
        ...
        when PROPAGATION_STYLE_B3
          extracted_context = DistributedTracing::B3.extract(env)
        when PROPAGATION_STYLE_B3_SINGLE_HEADER
          extracted_context = DistributedTracing::B3Single.extract(env)
        end
